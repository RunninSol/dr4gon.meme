        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gradient-to-br from-white/80 to-orange-50/80 border-2 border-red-200 rounded-xl p-5 shadow-lg">
            <div className="flex items-center space-x-4 mb-4">
              <div className="w-16 h-16 rounded-full border-2 border-orange-500 bg-black flex items-center justify-center p-2 shadow-lg shadow-orange-500/30 group overflow-hidden">
                <img 
